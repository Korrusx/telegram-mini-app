...
const returnClients = [
  { id: 1, name: "Анна Иванова", service: "Маникюр", days: 27, status: "Просрочен", avatar: "А" },
  { id: 2, name: "Мария Петрова", service: "Брови", days: 24, status: "Пора написать", avatar: "М" },
  { id: 3, name: "Екатерина Смирнова", service: "Массаж", days: 12, status: "Скоро", avatar: "Е" },
];
...
export const HomePage = () => {
  ...
  return (
    <Page>
      ...
      <Typography>Привет, {user?.first_name}!</Typography>
      ...
      <StatsRow direction="row" spacing={1.5}>
        <StatCard bg="#E8F7ED">
          ...
          <Typography color="success.main">+{stats.clientsDiff} новых</Typography>
        </StatCard>

        <StatCard bg="#FFF6E5">
          <Typography variant="caption">Пора вернуть</Typography>
          <Typography variant="h6">{stats.toReturn}</Typography>
          <Typography variant="caption">{stats.toReturnDiff} к вчера</Typography>
        </StatCard>
      ...
      <Box sx={{ mt: 2, textAlign: "center" }}>
        <Typography
          ...
          sx={{ color: "#6954EE", fontWeight: 600, cursor: "pointer", fontSize: 14 }}
        >
          Смотреть всех
        </Typography>
      </Box>
